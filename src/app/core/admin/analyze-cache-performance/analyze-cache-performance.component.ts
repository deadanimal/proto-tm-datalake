...
export class AnalyzeCachePerformanceComponent implements OnInit, OnDestroy {
  // Table
  ...
  getChart() {
    ...
    let chart = am4core.create("chartcache", am4charts.XYChart3D);
  ...
  getChart1() {
    let chart = am4core.create("chartcache1", am4charts.XYChart);
  ...
  getChart2() {
    let chart = am4core.create("chartcache2", am4charts.RadarChart);
  ...
  getChart3() {
    let chart = am4core.create("chartcache3", am4charts.XYChart);
